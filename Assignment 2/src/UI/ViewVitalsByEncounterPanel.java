 ...
 * @author madhav
 */
public class ViewVitalsByEncounterPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewVitalsByEncounterPanel
     */
    
DataService vital;
    Encounter e;
    
    public ViewVitalsByEncounterPanel(Encounter e, DataService vital) {
        initComponents();
        this.vital= vital;
        this.e =e;
...
private void populateTable() {
        ...
        model.setRowCount(0);
        ArrayList<VitalSigns> vitals = vital.getVital();
        ArrayList<VitalSigns> ans = new ArrayList<>();
//        ArrayList<VitalSigns> vitals = new ArrayList<>();
        for(VitalSigns v: vitals) {
            if(v.getId().equals(this.e.getVitalId())) {
                ans.add(v);
            }
        }
        for (VitalSigns vs :ans){
